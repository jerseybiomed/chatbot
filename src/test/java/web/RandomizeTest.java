...
class RandomizeTest {
	...
	public void rangeTestFirst() throws IOException {
		...
		assertTrue(1 <= Randomize.GetRandomNumber(request) && Randomize.GetRandomNumber(request) <= 2);
	}
	...
	public void rangeTestSecond() throws IOException {
		...
		assertTrue(1 <= Randomize.GetRandomNumber(request) && Randomize.GetRandomNumber(request) <= 5);
	}
	...
	public void rangeTestThird() throws IOException {
		...
		assertTrue(5 <= Randomize.GetRandomNumber(request) && Randomize.GetRandomNumber(request) <= 10);
	}
	...
	public void rangeTestFourth() throws IOException {
		...
		assertTrue(0 <= Randomize.GetRandomNumber(request) && Randomize.GetRandomNumber(request) <= 25);
	}
	...
	public void rangeTestFifth() throws IOException {
		...
		assertTrue(1 <= Randomize.GetRandomNumber(request) && Randomize.GetRandomNumber(request) <= 50);
	}
